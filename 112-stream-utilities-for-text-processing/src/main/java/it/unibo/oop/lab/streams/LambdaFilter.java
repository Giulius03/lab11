...
public final class LambdaFilter extends JFrame {
    ...
    private enum Command {
        ...
        LOWER("Convert to lower case", String::toLowerCase),
        NUM_CHARS("Count number of chars", c -> Integer.toString(c.length())),
        NUM_LINES("Count number of lines", l -> Long.toString(l.chars().filter(e -> e == '\n').count() + 1)),
        SORT("List the words in alphabetical order", s -> Arrays.stream(s.split(ANY_NON_WORD))
